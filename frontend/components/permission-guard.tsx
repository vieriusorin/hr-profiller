...
export const usePermissions = () => {
	...
	return {
		...
		canAny: (permissions: Permission[]) =>
			hasAnyPermission(userRole || "user", permissions),
		canAll: (permissions: Permission[]) =>
			permissions.every((p) => requirePermission(userRole, p)),
		role: userRole,
...
export const RoleIndicator = ({
	...
	return (
		<div
			className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${roleInfo.color} ${className}`}
		>
