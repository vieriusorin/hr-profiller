...
import { NavigationItem, getFilteredNavigation, ROLE_DISPLAY_INFO, UserRole } from '@/lib/rbac';
...
export const AppSidebar = () => {
  ...
  const allowedNavItems = getFilteredNavigation(userRole || 'user', navigationItems);
