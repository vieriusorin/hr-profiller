...
import { Users, Building, DollarSign, Plus, Eye, EyeOff, AlertTriangle, Phone, Mail } from 'lucide-react';
...
export default function ClientsPage() {
  ...
  const canViewFinancials = requirePermission(userRole, 'view_client_financials');
              ...
              <CardHeader className='pb-3'>
                <div className='flex items-start justify-between'>
                  ...
                  <Badge 
                    ...
                    className={client.status === 'Active' ? 'bg-primary/10 text-primary' : ''}
                  >
                    {client.status}
                  </Badge>
                </div>
          ...
          <Card className='border-primary/20'>
            <CardContent className='flex flex-col items-center justify-center py-12'>
              ...
              <p className='text-gray-600 text-center'>
                No clients available or you don't have permission to view them.
              </p>
            </CardContent>
          </Card>
        )}
