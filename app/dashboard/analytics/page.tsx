    ...
    <>
      ...
      <div className='p-6 max-w-7xl mx-auto'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6'>
          ...
          <Card className={componentThemes.card}>
            <CardHeader>
              <CardTitle className='text-primary'>Project Status Distribution</CardTitle>
              <CardDescription>Current status of all active projects</CardDescription>
            </CardHeader>
            <CardContent>
              <div className='h-64 flex items-center justify-center bg-primary/10 rounded-lg'>
                <p className='text-gray-500'>Project Status Chart Placeholder</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        {requirePermission(userRole, 'view_client_financials') && (
          <Card className={componentThemes.card}>
            <CardHeader>
              ...
              <CardDescription>Detailed financial metrics and projections</CardDescription>
            </CardHeader>
            <CardContent>
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                ...
                <div className='p-4 bg-primary/10 rounded-lg'>
                  <h3 className='font-semibold text-primary'>Operating Costs</h3>
                  <p className='text-2xl font-bold text-primary/90'>$1,876,420</p>
                </div>
                <div className='p-4 bg-primary/10 rounded-lg'>
