					...
					{row.roleId && row.roleStatus === "Open" && (
						<DropdownMenu>
							...
							<DropdownMenuContent align='start' className='w-32'>
								<DropdownMenuItem
									onClick={() =>
										handleUpdateRole(row.opportunityId, row.roleId!, "Won")
									}
								...
								<DropdownMenuItem
									onClick={() =>
										handleUpdateRole(row.opportunityId, row.roleId!, "Staffed")
									}
								...
								<DropdownMenuItem
									onClick={() =>
										handleUpdateRole(row.opportunityId, row.roleId!, "Lost")
									}
